...
async def word_actions(
    ...
    text = (
        f"Значение слово на английском языке: \n"
        f"{word.in_english}\n\n"
